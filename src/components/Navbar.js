            ...
            <div class="drawer-content flex flex-col">
                ...
                <div class="w-full navbar bg-base-100 fixed top-0 z-50 lg:px-20">
                    <div class="drawer-content flex flex-col items-center justify-center lg:hidden">
                        <label tabindex="0" for="my-drawer-2" class="btn btn-ghost">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h7" /></svg>
                        </label>
                    </div>
                    <div class="flex-1 px-2 mx-2 font-semibold text-2xl">Modern Tools</div>
                    ...
                    <div class="flex-none hidden lg:block">
                        <ul class="menu menu-horizontal gap-x-2">
                            ...
                            <li><NavLink className='rounded-lg' to='/manageItem'>Manage Item</NavLink></li>
