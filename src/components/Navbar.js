            ...
            <div className="drawer-content flex flex-col">
                ...
                <div className="w-full navbar bg-base-100 fixed top-0 z-50 lg:px-20">
                    <div className="drawer-content flex flex-col items-center justify-center lg:hidden">
                        <label tabIndex="0" htmlFor="my-drawer-2" className="btn btn-ghost">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h16M4 18h7" /></svg>
                        </label>
                    </div>
                    <div className="flex-1 px-2 mx-2 font-semibold text-2xl">Modern Tools</div>
                    ...
                    <div className="flex-none hidden lg:block">
                        <ul className="menu menu-horizontal gap-x-2">
                            ...
                            {/* <li className="dropdown dropdown-hover dropdown-end">
                                ...
                                <label tabIndex="0" className="btn btn-primary rounded-lg btn-outline m-1">Book Now</label>
